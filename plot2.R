...
par(mar=c(5,5,4,2))
# Plotting line graph of Global Active Power with proper annotation
plot(fd$DateTime,fd$Global_active_power, type="l", main="", ylab="Global Active Power (kilowatts)", xlab="")
# Copying to png file
